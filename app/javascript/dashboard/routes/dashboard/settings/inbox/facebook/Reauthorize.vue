  ...
  methods: {
    ...
    tryFBlogin() {
      FB.login(
        ...
        {
          scope:
            'pages_manage_metadata,pages_messaging,instagram_basic,pages_show_list,pages_read_engagement,pages_manage_engagement,instagram_manage_messages,instagram_manage_comments',
